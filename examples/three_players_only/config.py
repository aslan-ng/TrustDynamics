...
if __name__ == "__main__":
    ...
    normative_agent_opinions = [-0.5, 0.5]
    main_agent_opinions = [-0.5, 0.5]
    main_agent_self_trusts = [-0.5, 0.5]
    homophily_normative_tradeoffs = [0, 0.5, 1]
    technology_success_rates = np.linspace(0, 1, 3)
