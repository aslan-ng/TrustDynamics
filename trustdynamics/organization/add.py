...
class Add:
    ...
    def add_agent(
        ...
        technology_use_cutoff_opinion : float, optional
        ...
        if technology_use_cutoff_opinion < -1.0 or technology_use_cutoff_opinion > 1.0:
            raise ValueError("technology_use_cutoff_opinion must be between 0.0 and 1.0")
